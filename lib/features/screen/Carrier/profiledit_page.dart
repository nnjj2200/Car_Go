...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  final List<String> cities = [
    ...
    'Khobar', 'Tabuk', 'Hail', 'Buraidah', 'Al Kharj',
    'Najran', 'Al Jubail', 'Abha', 'Yanbu', 'Jizan',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                _buildTextField(label: "Commercial Registration Number", controller: _commercialNumberController),
                SizedBox(height: 16),
                _buildTextField(label: "Address (Street, City, Province, Zip Code)", controller: _addressController),
                SizedBox(height: 16),
                _buildTextField(label: "Fleet Size (Number of vehicles)", controller: _fleetSizeController),
                SizedBox(height: 24),
                ...
                Column(
                  ...
                  children: [
                    ...
                    // Subtitle
                    Text(
                      'Select cities or areas covered',
                      style: TextStyle(
                        fontSize: 14,
                ...
                Obx(() => _profileController.isLoading.value
                    ...
                    : ElevatedButton(
                  onPressed: () async {
                    await _profileController.updateVendor(
                      nameController: _nameController,
                      emailController: _emailController,
                      phoneController: _phoneController,
                      companyNameController: _companyNameController,
                      commercialNumberController: _commercialNumberController,
                      addressController: _addressController,
                      fleetSizeController: _fleetSizeController,
                    );
                  },
